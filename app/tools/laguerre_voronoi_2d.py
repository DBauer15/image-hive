'''
COPYRIGHT by marmakoide (https://github.com/marmakoide)
Source: https://gist.github.com/marmakoide/45d5389252683ae09c2df49d0548a627
'''
...
def display(S, R, tri_list, voronoi_cell_map):
    ...
    edge_map = {}
    for segment_list in voronoi_cell_map.itervalues():
